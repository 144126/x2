...
declare module '$env/static/private' {
	...
	export const NARAROUTER_API_KEY: string;
	...
	export const LLM_API_BASE: string;
	...
	export const PIPER_VOICES_DIR: string;
