...
<section class="flex h-full flex-col items-center justify-center py-6 text-center">
	...
	{:else}
		...
		<div class="reveal mt-10 grid w-full max-w-[620px] gap-2 text-left sm:grid-cols-2">
			<a class="card group" href="/rooms">
				<span
				...
				<p class="mt-1 text-[12.5px] leading-[1.5] text-ink-soft">
					conversations already going. read any of them without an account.
				</p>
			</a>
			<a class="card group" href="/find">
				<span
					class="font-display text-[15px] font-medium transition-colors duration-300 group-hover:text-accent"
					>find people</span
				>
